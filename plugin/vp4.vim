...
call s:set('g:vp4_annotate_cross_branch', 1)
call s:set('g:vp4_annotate_bot_users', ['NGRBuild', 'NGRAutoMerge'])
...
command! -nargs=? Vp4AnnotateLine call vp4#PerforceAnnotateLine(<f-args>)
